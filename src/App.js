...
// ...The rest of your components (ConfirmationModal, Header, Nav, FilmInventory, etc.) remain the same...
// Make sure they correctly receive and use the userId prop, which is now user.uid
